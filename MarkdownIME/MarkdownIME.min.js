...
*/
var MarkdownIME;(function(e){function t(e){var n=e.document;var r;r=[].slice.call(n.querySelectorAll("[contenteditable], [designMode]"));[].forEach.call(n.querySelectorAll("iframe"),function(e){try{var n=t(e.contentWindow);r=r.concat(n)}catch(i){}});return r}e.Scan=t;function n(t){if(typeof t["length"]==="number"&&t[0]){return[].map.call(t,n)}var r;r=new e.Editor(t);if(r.Init())return r;return null}e.Enhance=n;function r(r){n(t(r)).forEach(function(t){if(!t)return;e.UI.Toast.makeToast("MarkdownIME Activated",t.editor,e.UI.Toast.SHORT).show()})}e.Bookmarklet=r})(MarkdownIME||(MarkdownIME={}));var MarkdownIME;(function(e){var t;(function(t){var n=function(){function t(){this.name="MathFormula";this.imgServer="http://latex.codecogs.com/gif.latex?";this.regex=/([^\\]|^)(\${1,2})(.*?[^\\])\2/g}t.prototype.render=function(t){var n=this;t.replace(this.regex,function(t,r,i,a){var o=e.Utils.text2html(a);var s=n.imgServer+encodeURIComponent(a);var l="<!--protect--><!--formula:"+o+'--><img alt="'+o+'" class="formula" src="'+s+'"><!--/protect-->';return r+l})};t.prototype.unrender=function(t){t.screwUp(/<!--protect--><!--formula:(.+?)--><img .+?><!--\/protect-->/g,function(t,n){return"$"+e.Utils.html_entity_decode(n)+"$"})};return t}();t.MathAddon=n})(t=e.Addon||(e.Addon={}))})(MarkdownIME||(MarkdownIME={}));